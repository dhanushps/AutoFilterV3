    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🎖 JOIN CHANNEL 🎖', url=f'{TUTORIAL}')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton('⚙️ᴀᴅᴅ ᴍᴇ ᴛᴏ yᴏᴜʀ ɢʀᴏᴜᴩ⚙️', url='https://t.me/Kurup_bmbot?startgroup=true')
                ],[
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('⚙️Group⚙️', url='https://t.me/joinchat/quY_4ms_67g4MTA9')
        ]
        ]
